...
function _calcWidth() {
    ...
    if (width === 414) {
        ...
        // small iOS devices (eg 4, 4s)
        return Shared.deviceWidth - 40;
    }
}
...
class Stage extends React.Component {
        ...
        if (stores.Stage.displayAds) {
            return (
                <View style={styles.adSpace}>
                    <Text style={styles.adSpaceText}>BLOCKCHAIN AD SPACE</Text>
                </View>
            );
        }
    }
    ...
    _displayDescription() {
        if (stores.Stage.ziteAddress) {
            return (
                <View style={styles.ziteDetails}>
                    <Text style={styles.ziteDetailsHeader}>Description</Text>
                    <Text style={styles.ziteDetailsText}>
    ...
    _displayLastUpdate() {
        if (stores.Stage.ziteAddress) {
            return (
                <View style={styles.ziteDetails}>
                    <Text style={styles.ziteDetailsHeader}>Last Updated</Text>
                    <Text style={styles.ziteDetailsText}>
    ...
    _displayFileList() {
        if (stores.Stage.ziteFiles.length > 0) {
            return (
                <View style={styles.ziteDetails}>
                    <Text style={styles.ziteDetailsHeader}>File Directory</Text>
