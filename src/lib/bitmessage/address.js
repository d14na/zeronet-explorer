...
const popkey = require('./_util').popkey
const PubkeyBitfield = require('./structs').PubkeyBitfield
const var_int = require('./structs').var_int
...
Address.decode = function(str) {
    ...
    return new Address({ version, stream, ripe })
}
